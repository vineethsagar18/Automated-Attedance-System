  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-linear-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
        ...
        <div className="relative z-20 flex items-end justify-center h-125">
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            >
              ...
              >
                <Pupil size={12} maxDistance={5} pupilColor="#2C2C2C" forceLookX={(password.length > 0 && showPassword) ? -5 : undefined} forceLookY={(password.length > 0 && showPassword) ? -4 : undefined} />
                <Pupil size={12} maxDistance={5} pupilColor="#2C2C2C" forceLookX={(password.length > 0 && showPassword) ? -5 : undefined} forceLookY={(password.length > 0 && showPassword) ? -4 : undefined} />
              </div>
            </div>
            ...
            >
              ...
              <div 
                className="absolute w-20 h-1 bg-[#2C2C2C] rounded-full transition-all duration-200 ease-out"
                style={{
        ...
        {/* Decorative elements */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#f3f4f41a_1px,transparent_1px),linear-gradient(to_bottom,#f3f4f41a_1px,transparent_1px)] bg-size-[40px_40px]" />
