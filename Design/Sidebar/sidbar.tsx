      ...
      >
        <motion.ul variants={staggerVariants} className="flex h-full flex-col">
          <div className="flex grow flex-col items-center">
            <div className="flex h-13.5 w-full shrink-0  border-b p-2">
                  ...
                  <div className={cn("flex w-full flex-col gap-1")}>
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname?.includes("chat") && "bg-primary/10 text-primary",
                      )}
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <div className="ml-2 flex items-center  gap-2">
                            ...
                            <Badge
                              className={cn(
                                "flex h-fit w-fit items-center gap-1.5 rounded border-none bg-secondary/15 px-1.5 text-secondary",
                              )}
                              variant="outline"
                            >
                              BETA
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname?.includes("deals") && "bg-primary/10 text-primary",
                      )}
                    >
