...
const ToastContainer = () => {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-9999 pointer-events-none w-105"
        ...
        {toasts.map((toast, index) => {
          ...
          return (
            <div
              ...
              className={clsx(
                "absolute right-0 bottom-0 shadow-menu rounded-xl leading-5.25 p-4 h-fit",
                {
                  message: "bg-[#F3F4F4] text-[#2C2C2C]",
                  success: "bg-[#612D53] text-[#F3F4F4]",
                  warning: "bg-[#853953] text-[#F3F4F4]",
                  error: "bg-[#2C2C2C] text-[#F3F4F4]"
                }[toast.type],
